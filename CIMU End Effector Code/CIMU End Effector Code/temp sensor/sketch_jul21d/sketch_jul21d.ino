...
void sendHelp() {
  ...
  // should look over functionality of this command 
  Serial.println("  RATE 1000");
  // I don't think the avg 5 works as intended
  Serial.println("  AVG 5");
  Serial.println("  REINIT");
  //testing purposes: just in case I forget what the commands are when working from serial monitor
  Serial.println("  HELP");
}
